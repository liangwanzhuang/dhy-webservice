...
namespace DataBaseHelper
{
    public sealed class SqlHelper
    {
        ...
        public static object ExecuteSPOutput(string connectionString, string spName, string hisid, string psp)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    //为参数赋值
                    int hid = Convert.ToInt16(hisid);
                    myCmd.Parameters["@hospitalid"].Value = hid;
                    myCmd.Parameters["@cf"].Value = psp;
                    ...
                    retval = myCmd.Parameters["@jz_id"].Value;
